...
1. **Conceitos Fundamentais** (Atributos, Perícias, Reflexões, Recursos)
2. **Criação de Personagem** (Distribuição de pontos, equipamento, Reflexão inicial)
3. **Sistema de Resolução** (Testes, dificuldades, passivos, assistidos)
4. **As 24 Vozes** (Perícias detalhadas com descrições narrativas)
5. **Gabinete de Reflexões** (Sistema de ideologias e obsessões)
6. **Moral, Saúde e Recursos** (Sobrevivência interna e externa)
7. **Progressão** (Ganho de XP, evolução de perícias e atributos)
8. **Mecânicas Avançadas** (Condições, conflitos, diálogo com o mundo)
9. **Referências Rápidas** (Tabelas e fichas prontas)
10. **Conselhos de Narrador** (Como conduzir o sistema)
...
- **MOTRICIDADE (MOT)**: Destreza, percepção, reflexos
...
- **Condições**: Ideias e sentimentos passageiros que dão bônus ou penalidades narrativos e mecânicos.
- **Dinheiro**: Reais (R$). Serve para sobreviver e, paradoxalmente, para comprar "crescimento".
...
- **Veloz e Perigoso:** INT 2, PSY 1, FYS 3, MOT 4

## **2.2. Distribuição de Perícias**
...
- **Equipamento**: Roupas básicas, 1 item pessoal narrativo, R$ 10
...
| CD  | Grau       | Descrição                          |
| --- | ---------- | ---------------------------------- |
| 6   | Trivial    | Automático para quem tem a perícia |
| 8   | Fácil      | Exige atenção mínima               |
| 10  | Médio      | Desafio comum para aventureiros    |
| 12  | Desafiador | Requer especialização              |
| 14  | Formidável | Apenas experts passam              |
| 16  | Lendário   | Heróico e raro                     |

### **3.2. Tipos de Teste**

**Testes Brancos:** Podem ser repetidos após subir o nível da perícia envolvida.

**Testes Vermelhos:** Uma única chance. Falhar não bloqueia progresso, mas causa **desvios radicais na trama** - muitas vezes piores que o sucesso.

**Teste Passivo (Insight):** Ocorre automaticamente **quando relevante para a cena**. **Fórmula:** Nível da Perícia + Nível do Atributo + 6

**Regra do Narrador:** Um teste passivo só acontece quando a situação atual possui elementos que **ativariam** naturalmente a percepção do personagem. O Narrador determina se a circunstância justifica a ativação de uma perícia passiva — por exemplo, se o personagem tem alta Percepção e está num ambiente onde há detalhes ocultos relevantes, o teste passivo ativa-se automaticamente. Quando ativado, o Narrador deve entregar **uma informação relevante** ao jogador, mesmo que não tenha solicitado. Informações passivas são limitadas a **1 por cena** para evitar sobrecarga. Quando a Moral do personagem está em 0, o Narrador pode optar por entregar informações **distorcidas ou paranoicas** em vez de fatos claros, representando as vozes descontroladas.
...
## **4. AS 24 VOZES (PERÍCIAS)**

Cada perícia é uma voz personificada que influencia a narrativa e oferece bônus específicos quando internalizada. O Narrador deve interpretar essas vozes conforme os testes de perícia são feitos e for pertinente para a trama.

### **4.1. INTELECTO (INT)**

| Perícia              | Descrição Narrativa                                                                                                                                                 | Efeito Mecânico                                                                                                                                                                                                                               |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lógica**           | O pedante que analisa tecnicamente cada argumento, contando cada premissa como quem conta granos de arroz. Ele não desgruda do seu ouvido quando você tenta dormir. | **+1 sucesso em deduções; limite de nível +1**<br>Adiciona +1 ao resultado final de qualquer teste de Lógica. Aumenta seu limite máximo de nível nessa perícia em +1, permitindo que você invista mais pontos de perícia aqui no futuro.      |
| **Enciclopédia**     | O nerd que vomita curiosidades aleatórias, conectando o assassinato atual com a dinastia de um imperador morto há 400 anos. Ele só para quando você bebe.           | **Desbloqueia lore; limite de nível +1**<br>Quando bem-sucedido, revela fatos históricos, culturais ou científicos sobre o mundo. O Narrador fornece informações de contexto que podem conter pistas. Aumenta o limite máximo de nível em +1. |
| **Retórica**         | O advogado que ensaia discursos no espelho, preparando contra-argumentos para debates que nunca acontecerão. Ele chora quando você desiste de discutir.             | **Abre opções de persuasão; limite de nível +1**<br>Testes bem-sucedidos desbloqueiam novas opções de diálogo para convencer NPCs. Você pode identificar falhas lógicas no discurso de outros. Aumenta o limite máximo de nível em +1.        |
| **Conceitualização** | O artista que vê metáforas até numa poça de óleo, convencido de que a arte do real é mais real que o real. Ele vende suas próprias pinturas para comprar drogas.    | **Interpreta arte abstrata; limite de nível +1**<br>Permite compreender conceitos abstratos, ideologias e obras de arte. Pode criar teorias sofisticadas sobre eventos. Aumenta o limite máximo de nível em +1.                               |
| **Cálculo Visual**   | O engenheiro que reconstrói acidentes mentalmente, vendo vetores de força e ângulos de impacto. Ele não consegue desligar isso quando olha para pessoas.            | **Reconstrói cenas; limite de nível +1**<br>Testes bem-sucedidos permitem recriar visualmente cenas de crime ou acidentes, revelando detalhes ocultos. Útil para investigações. Aumenta o limite máximo de nível em +1.                       |
| **Drama**            | O diretor que suspeita que toda vida é teatro, que todos estão "encenando" algo. Ele aplaude quando você descobre uma mentira.                                      | **Detecta blefes; limite de nível +1**<br>Identifica quando alguém está encenando ou escondendo algo. Também ajuda a blefar em situações sociais. Aumenta o limite máximo de nível em +1.                                                     |
...
| **Sugestão**               | O hipnotizador que planta ideias como sementes, fazendo você achar que aquilo foi seu pensamento. Ele ri quando você pensa nele.                       | **Manipulação sutil; limite de nível +1**<br>Permite plantar ideias na mente de outros sem confronto direto. Testes bem-sucedidos desbloqueiam opções de diálogo manipuladoras. Aumenta o limite máximo de nível em +1. |
...
| Perícia                  | Descrição Narrativa                                                                                                                                          | Efeito Mecânico                                                                                                                                                                                                             |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Coordenação Mão-Olho** | O atirador que conta costelas antes de mirar, vendo cada respiração como uma variável a ser calculada. Ele não confia em ninguém que segura uma arma errado. | **Precisão com armas; limite de nível +1**<br>Adiciona +1 ao resultado final de testes de pontaria e manipulação fina. Crucial para combate à distância. Aumenta o limite máximo de nível em +1.                            |
| **Percepção**            | O gato que nota um grão de areia fora do lugar, que vê o micro-movimento da pupila antes da mentira. Ele te obriga a prestar atenção em tudo.                | **Encontra pistas ocultas; limite de nível +1**<br>Testes bem-sucedidos revelam detalhes invisíveis ao olho nu, objetos escondidos e micro-expressões. Essencial para investigação. Aumenta o limite máximo de nível em +1. |
| **Velocidade de Reação** | O reflexo que atira antes do pensamento chegar, que pega a xícara caindo sem olhar. Ele é o único que te salva quando você não tem tempo de pensar.          | **Iniciativa; limite de nível +1**<br>Determina quem age primeiro em situações de conflito. Altos níveis permitem reações instintivas antes de consciente. Aumenta o limite máximo de nível em +1.                          |
| **Savoire Faire**        | O ladrão que desliza por corredores como se dançasse, para quem cada obstáculo é uma oportunidade de mostrar estilo. Ele ri quando você escorrega.           | **Furtividade & estilo; limite de nível +1**<br>Testes bem-sucedidos permitem passar despercebido, realizar furtos e manobras evasivas elegantes. Aumenta o limite máximo de nível em +1.                                   |
| **Interface**            | O técnico que diz "olá" para máquinas e elas respondem, convencido de que tecnologia tem alma. Ele chora quando você desliga um computador.                  | **Hackear/consertar; limite de nível +1**<br>Permite interagir com aparelhos tecnológicos, consertar ou sabotar equipamentos. Aumenta o limite máximo de nível em +1.                                                       |
| **Composição**           | O diplomata que mantém a postura mesmo com o teto caindo, que sorri quando recebe um soco. Ele é a última barreira entre você e o descontrole total.         | **Resiste a intimidação; limite de nível +1**<br>Testes bem-sucedidos permitem manter a calma sob pressão social e resistir a efeitos de Moral causados por intimidação. Aumenta o limite máximo de nível em +1.            |

---

## **5. GABINETE DE REFLEXÕES**
...
4. **Conclusão**: Ideia torna-se permanente, concedendo a **Solução** (bônus permanente)

**Estratégia Narrativa:** Internalizar uma Reflexão é uma **declaração de identidade**. Enquanto a internaliza, o personagem do jogador **realmente acredita** naquilo.

### **5.2. Regras de Slots**

- **Slots Iniciais**: 3
- **Custo**: +1 slot = **1 Ponto de Perícia**
- **Máximo**: 12 slots ativos
- **Proibição**: Não pode internalizar a mesma Reflexão duas vezes
- **Conflito**: Reflexões opostas ativam **Colapso Ideológico** (ver Seção 8.3)

### **5.3. Tempo de Processamento**

| Nível | Duração     | Redução de Penalidade              |
| ----- | ----------- | ---------------------------------- |
| **1** | 1-2 Cenas   | Nenhuma                            |
| **2** | 1 Sessão    | Nenhuma                            |
| **3** | 2-3 Sessões | Reduz pela metade na última sessão |
| **4** | 4-6 Sessões | Ausente na última sessão           |

**Epifania Acelerada (Níveis 3-4):** Force a conclusão pagando **2 pontos de Moral permanentes**, que seria a representação de uma cicatriz psicológica.

### **5.4. Criando Reflexões Personalizadas**

**Passo 1: Identifique a Semente**
O que o jogador **repete** ou **defende** com veemência?

**Passo 2: Defina o Problema**
Penalidade de **-1 a -4** em uma ou duas perícias + efeito narrativo.

**Passo 3: Elabore a Solução**
...
## **6. REFLEXÕES SUGERIDAS**

### **6.1. Nível 1: Manias de Bar (1-2 Cenas)**
...
Quando **Moral** ou **Saúde** chega a 0, ativa-se **Colapso Interno**:

1. **Conflito de Vozes**: Narrador descreve duas perícias contraditórias
2. **Escolha Penalizada**: Siga uma voz, a outra fica **Ressentida** (-1 acumulativo em futuros testes)
3. **Feedback Loop**: A cada 5 ações, teste de Vontade CD 15. Falha = -1 permanente em Moral **OU** Saúde
4. **Perca do personagem**: Caso falhe por três feedback loop motivado por **Moral**, personagem desiste do que está fazendo, na pratica se torna um personagem do Narrador marcado por todo o histórico até então.
5. **Morte**: Caso falhe por três feedback loop motivado por **Saúde**, personagem morre.
6. **Continuidade**: Caso o jogador queira continuar, deve criar novo personagem, este herda uma das **Reflexões** obtidas pelo personagem anterior como sua **crença central**.

**Recuperação:** Requer intervenção externa, isto é, qualquer coisa que recupere o motivador do colapso (aliado, drogas pesadas, 24h de descanso seguro, cuidados médicos, etc).

---

## **8. CONFLITO FÍSICO**

O combate em Detective Existencial pode ser brutal, rápido e sujo. A violência não é glorificada — é uma consequência da degradação, da desesperança e da proximidade demais com o fundo da cidade. Cada soco, cada facada, cada tiro carrega peso. Use este sistema com a consciência de que ferimentos são memoráveis e a dor é real.

### **8.1. Resolução de Conflitos Físicos**

Quando a violência irrompe, siga esta sequência:

**1. Determinação de Iniciativa**
Quem possui **Velocidade de Reação** mais alta age primeiro. Em caso de empate, ambos fazem teste de **Meia-Luz** — maior número age primeiro.
...
**4. Dano**
Se o atacante obtiver **sucesso**, isto é, maior ou igual ao teste do defensor, o golpe atinge. **Cada falha no teste de ataque ou defesa resulta em 1 ponto de dano em Saúde** — não importa se foi um soco ou um tiro. A brutalidade está na consistência, não na quantidade.

**Regra de Instante de Morte:** Se um personagem com Saúde 3 ou menos sofre dano que o levaria a 0 ou menos, deve fazer um teste de **Vontade CD 14**. Falha significa que o personagem entra em colapso imediato, incapaz de continuar a lutar. Sucesso permite atuar mais uma vez antes de desmaiar.
...
**Armas improvisadas:** Qualquer objeto pode ser usado como arma. O Narrador decide o bônus (normalmente 0 ou +1). Armas improvisadas frequentemente quebram ou são menos **efetivas**.
...
### **9.1. Ganho de Experiência (XP)**

| Fonte                             | XP         | Condições                   |
| --------------------------------- | ---------- | --------------------------- |
| Descobrir novo ponto de interação | +5         | Primeira vez por objeto/NPC |
| Completar objetivo                | +20 a +100 | Complexidade narrativa      |
| Sucesso em teste                  | +10        | Qualquer teste ativo        |
| **Falha crítica (Vermelho)**      | **+15**    | Recompensa pela ousadia     |
| Falha com estilo (Branco)         | +5         | Aprendizado pelo erro       |
| Progressão narrativa              | +50        | Por "marco narrativo"       |
...
### **10.2. Condições Narrativas**

Condições são estados temporários impostos pelo mundo. Funcionam como as Reflexões, porém não ocupam slots de Reflexão.

| Condição                  | Origem                                                                                           | Efeito Mecânico                                                                                              | Duração/Remoção                             |
| ------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| **Sangramento Leve**      | Receber dano físico                                                                              | -1 em testes de Percepção até limpar                                                                         | Ação livre para limpar OU 1 cena            |
| **Braço Ferido**          | Receber dano de arma cortante                                                                    | -1 em testes de Instrumento Físico                                                                           | Recupere 1 Saúde OU teste Resistência CD 10 |
| **Perda de Equilíbrio**   | Falha crítica em combate                                                                         | -2 em todos os testes até levantar                                                                           | Ação livre para levantar                    |
| **Dor Excruciante**       | Saúde 2 ou menos                                                                                 | -2 em todos os testes físicos                                                                                | Recupere Saúde acima de 2                   |
| **Débito Existencial**    | Gastar além do saldo                                                                             | -1 Vontade, +2 Retórica vs credores                                                                          | Pagar dívida + R$ 20 OU internalizar        |
| **Desajustado Funcional** | 3 Colapsos Internos                                                                              | -2 Composição, +1 Império Interior & limite +1                                                               | Permanente                                  |
| **Embriaguez**            | Consumir álcool                                                                                  | +1 Moral, -1 Percepção, -1 Coordenação                                                                       | 1 cena + ressaca                            |
| **Exaustão Severa**       | Saúde 0                                                                                          | -1 em todos os testes físicos                                                                                | Recupere Saúde 1                            |
| **Insonia Crônica**       | Dormir na rua                                                                                    | -1 Vontade                                                                                                   | 3 noites em hotel decente                   |
| **Intoxicação Leve**      | Comida de banca                                                                                  | -1 Resistência                                                                                               | 1 dia de descanso                           |
| **Paranóia**              | Falhar Meia-Luz                                                                                  | Narrador fornece 1 informação falsa/cena                                                                     | Recupere Moral OU teste PSY CD 13           |
| **Perseguido**            | Dívidas com agiota                                                                               | -2 em testes sociais                                                                                         | Pagar R$ 75 + R$ 50 OU matar agiota         |
| **Vício Leve**            | Falhar Eletroquímica CD 10                                                                       | -1 Moral se não consumir a cada 3 cenas                                                                      | Terapia ou 1 sessão abstinente              |
| **Vício Grave**           | Falha crítica em Eletroquímica                                                                   | -2 Moral, -1 Vontade se não consumir                                                                         | Intervenção narrativa                       |
| **Vício Crônico**         | Usar drogas duras repetidamente                                                                  | -2 Moral, -1 Vontade se não consumir                                                                         | Reabilitação                                |
| **Visão Paradoxal**       | Sofrer 3 ou mais falhas em testes de Vontade para evitar Colapso Ideológico ao longo da campanha | -1 Moral permanente e abandonar uma das duas Reflexões contradizentes e os Pontos de Perícia investidos nela | Efeito e resolução imediatos                |

**Nota sobre Condições de Combate:**
As condições Sangramento Leve, Braço Ferido, Perda de Equilíbrio e Dor Excruciante são impostas automaticamente durante confrontos físicos conforme as regras do Sistema de Combate (Seção 9.6).

### **10.3. Reflexões Conflitantes**

Reflexões ideologicamente opostas (ex: "Fascismo Racional" + "Complexo Dialético") criam **Colapso Ideológico**:

- Ao final de cada sessão: Teste de Vontade CD 15
- **Falha**: **Visão Paradoxal**
- **Crítico (16+)**: Reduz CD para 12 até o fim da campanha

**Solução:** Abandonar uma Reflexão (gaste 1 Ponto de Perícia) ou criar Reflexão de síntese via arco narrativo.
...
### **10.6. Eventos Aleatórios Urbanos**

Quando a Cidade está ferida (Moral ou Saúde abaixo de 3) ou quando o Narrador deseja adicionar atmosfera, role 1d20 para determinar que evento aleatório sacode os personagens. Estes eventos são momentos de caos existencial, pequenos dramas que interrompem a narrativa ou a enriquecem.

| d20    | Evento                    | Efeito Narrativo                                                                                                                                                                                 |
| ------ | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **1**  | **GRITO NA ESCURIDÃO**    | Um grito feminino ecoa de um beco próximo. Teste de Percepção CD 10 para localizar a fonte. Se investigar: encontro com violência em andamento ou evidência de crime recente.                    |
| **2**  | **CHUVA ÁCIDA**           | A chuva começa a cair, tingida de um amarelo doentio. Exposição prolongada causa -1 Saúde a cada 30 minutos ao ar livre. A cidade parece chorar toxina.                                          |
| **3**  | **BÊBADO FILOSÓFICO**     | Um homem sentado na calçada oferece uma garrafa e uma teoria conspiratória sobre a cidade. Teste de Empatia CD 10: pode revelar informação útil ou ser armadilha.                                |
| **4**  | **PERSEGUIÇÃO POLICIAL**  | Sirenes à distância. Dois guardas passam correndo. Teste de Meia-Luz CD 12: você nota que eles perseguem alguém que se parece com você.                                                          |
| **5**  | **CATASTROFE MENOR**      | Um prédio distante explode em chamas. Teste de Enciclopédia CD 12: você reconhece o endereço como algum lugar significativo para a sua investigação.                                             |
| **6**  | **VENDEDOR AMBULANTE**    | Um homem vende jornais que contêm uma manchetepertinente à sua investigação. Por R$ 2, você compra informação crucial — ou desinformação plantada.                                               |
| **7**  | **CIDADÃO INTOXICADO**    | Um morador local desmama no chão, espuma na boca. Teste de Eletroquímica CD 8: você identifica a substância. Teste CD 12 mais alto: você reconhece o veneno.                                     |
| **8**  | **MEMÓRIA INVOLUNTÁRIA**  | Um cheiro, um som, uma sombra — você é transportado para um momento do seu passado. O Narrador descreve uma memória fragmentada. Teste de Vontade CD 10 ou ganhe -1 Moral temporário.            |
| **9**  | **TENTATIVA DE ROUBO**    | Alguém tenta furtar sua carteira. Teste de Savoire Faire CD 10: você nota antes que seja tarde. O ladrão pode ser uma criança ou um velho — use isso.                                            |
| **10** | **FANTASMA DO SISTEMA**   | Um velho terminal de computador ainda funciona. Teste de Interface CD 8: você acidentalmente acessa um arquivo deletado que contém informação perturbadora.                                      |
| **11** | **ASSALTO EM ANDAMENTO**  | Você presencia um assalto a uma loja. Intervir exige teste de Meia-Luz CD 12. Ignorar causa -1 Moral (teste Vontade CD 8 para superar).                                                          |
| **12** | **VOZ NA PAREDE**         | Graffitis recentes parecem formar palavras. Teste de Conceitualização CD 10: você lê uma mensagem que parece direcionada a você especificamente.                                                 |
| **13** | **FALHA DE ENERGIA**      | Todos os postes de luz apagam-se numa área de três quarteirões. No escuro, Teste de Percepção CD 14. Teste de Arrepios CD 10: a cidade sussurra o que está escondido.                            |
| **14** | **ENCONTRO COM EX**       | Um ex-colega, ex-parceiro, ex-amante aparece. Teste de Drama CD 12: você disfarça suas intenções. A pessoa pode ter informação — ou ser o alvo.                                                  |
| **15** | **POMBOS CORRUPTOS**      | Um bando de pombos ataca um homem que tentava alimentá-los. Ele carrega uma pasta com selo oficial. Teste de Percepção CD 12: você vê o que há na pasta antes que ele fuja.                      |
| **16** | **GRITO DE ALERTA**       | Uma criança grita "Ladrão!" e aponta para você. Teste de Autoridade CD 12 para esclarecer a situação antes que a multidão reaja.                                                                 |
| **17** | **MENSAGEIRO MISTERIOSO** | Um homem de terno entrega-lhe um envelope sem dizer quem o enviou. Dentro: foto de alguém que você conhece, ou uma ameaça, ou um convite. Teste de Enciclopédia CD 10 para identificar a origem. |
| **18** | **ANIMAL MORTO**          | Um gato preto jaz morto na calçada, com um objeto ao redor do pescoço. Teste de Cálculo Visual CD 10: você rekonstrui como chegou ali. Teste CD 14: você reconhece o objeto.                     |
| **19** | **CERVEJA GRÁTIS**        | Um estranho num bar oferece drinks"porque hoje é seu dia de sorte". Teste de Eletroquímica CD 8: você identifica a substância misturada. Teste de Empatia CD 12: você sente as intenções dele.   |
| **20** | **REVELAÇÃO NO MURO**     | Enquanto caminha, você vê pichado na parede um detalle que resolve uma parte da investigação. Teste de Lógica CD 8 para conectar à teoria maior.                                                 |
...
- **Gaste R$ 50+** em substâncias, livros, experiências: **+10 XP** (limite 1x por sessão)
- **Gaste R$ 100+** em esbórnia: **+20 XP** + Reflexão Nível 1 automática (limite 1x por arco)

### **11.3. Alternativas de Subsistência**

| Método                     | Ganho               | Consequência                                     |
| -------------------------- | ------------------- | ------------------------------------------------ |
| **Abrigo de Caridade**     | +1 Moral (descanso) | Teste Autoridade CD 8 ou Débito Existencial      |
| **Comida de Banca**        | +1 Saúde            | Teste Eletroquímica CD 10 ou Intoxicação Leve    |
| **Dormir na Rua**          | Grátis              | Teste Arrepios CD 10 ou Insonia Crônica          |
| **Catação de Recicláveis** | +R$ 5 +1 XP         | Teste Instrumento Físico CD 8 ou -1 Saúde        |
| **Igreja/Missionário**     | +2 Moral, +1 Saúde  | Ouça sermão (teste Retórica CD 10 ou -1 Vontade) |
| **Empréstimo Agiota**      | +R$ 50              | Dívida: R$ 75 em 3 dias ou Perseguido            |

### **11.4. Estados Financeiros**

| Estado                  | Efeitos                                                        |
| ----------------------- | -------------------------------------------------------------- |
| **R$ 0 (Falido)**       | Débito Existencial obrigatória; testes de compra são Vermelhos |
| **R$ 1-25 (Pobre)**     | Perícias INT sofrem -1 (obsessão com dinheiro)                 |
| **R$ 26-100 (Estável)** | Nenhum efeito                                                  |
| **R$ 101+ (Rico)**      | +1 Autoridade, -1 Empatia                                      |
...
- **Saúde Máxima:** 1 + Resistência (limite 15 com bônus)
- **XP por Ponto de Perícia:** 50 XP
...
### **14.4. Conexão obrigatória a trama**

Se eles inventam um NPC, lugar ou objeto, você deve conectar a trama principal.
...
**Você não criou. Eles projetaram. Você reagiu.**
...
Se você **resolveu sozinho**, **você falhou**. A cidade só existe se **eles vomitarem neurose** nela.
...
4. **Subsistência como drama**: Dinheiro é tanto recurso quanto motor de conflito
...
- A essência é dialética: o conflito interno manifesta no externo e o externo reflete no conflito interno

---

## **17. GLOSSÁRIO DE TERMOS**

Este glossário serve como referência rápida para todos os termos mecânicos e narrativos utilizados no sistema. Familiarize-se com estes conceitos para facilitar a comunicação durante as sessões.

### 17.1. **Termos Mecânicos**

- **Ataque Assistido:** Teste que utiliza 3d6 (descartando o menor) quando o personagem possui duas perícias relevantes com nível 3 ou mais, ou quando recebe ajuda de um aliado ou Reflexão aplicável.
- **Colapso Interno:** Estado ativado quando Moral ou Saúde atinge zero. O Narrador apresenta duas vozes contraditórias; seguir uma penaliza a outra. Falhas consecutivas em testes de Vontade podem resultar em consequências permanentes ou perda do personagem.
- **Colapso Ideológico:** Conflito entre Reflexões ideologicamente opostas. Requer teste de Vontade ao final de cada sessão; falha resulta em penalidades permanentes e Visão Paradoxal.
- **Condição:** Estado temporário imposto pelo mundo que concede bônus ou penalidades. Não ocupa slots de Reflexão e possui duração ou gatilhos específicos para remoção.
- **Dano em Saúde:** Redução do recurso Saúde caused por falhas em testes de Limiar de Dor, exaustão extrema ou ataques físicos bem-sucedidos.
- **Dano em Moral:** Redução do recurso Moral caused por falhas em testes de Vontade, sobrecarga emocional através de Empatia alta, ou exposição a trauma.
- **Epifania Acelerada:** Processo de forçar a conclusão de uma Reflexão de Nível 3 ou 4 pagando 2 pontos de Moral permanentes como "cicatrizes psicológicas".
- **Feedback Loop:** Durante Colapso Interno, cada 5 ações do personagem exige teste de Vontade CD 15. Falhas repetidas podem levar à perda permanente de recursos ou do personagem.
- **Limite de Perícia:** Nível máximo que uma perícia pode atingir, determinado pelo nível do Atributo pai mais bônus de Reflexões. Exceder este limite ativa Sobrecarga Temporal.
- **Passivo (Insight):** Teste que ocorre automaticamente quando relevante para a cena, sem ação do jogador. Fórmula: Nível da Perícia + Nível do Atributo + 6.
- **Problema:** Fase de processamento de uma Reflexão durante a qual o personagem sofre penalidades narrativas e mecânicas antes de receber a Solução final.
- **Reflexão:** Ideologia internalizada que ocupa um slot no Gabinete de Reflexões. Passa por Problema antes de conceder Solução permanente.
- **Slot de Reflexão:** Espaço disponível no Gabinete de Reflexões para internalizar novas ideologias. Slots iniciais: 3. Máximo: 12.
- **Sobrecarga Temporal:** Penalidade aplicada quando uma perícia excede o nível do Atributo pai. Efeito: -4 em testes dessa perícia e interpretação da voz como irritante ou obsessiva.
- **Solução:** Bônus permanente concedido após o período de processamento de uma Reflexão. Pode incluir bônus em perícias, limites aumentados, ou recursos adicionais.
- **Teste Assistido:** Ver "Ataque Assistido".
- **Teste Branco:** Teste que pode ser repetido após subir o nível da perícia envolvida. Falhas não bloqueiam progresso narrativo.
- **Teste Passivo:** Ver "Passivo (Insight)".
- **Teste Vermelho:** Teste de uma única chance. Falhas não bloqueiam progresso, mas causam desvios radicais na trama, frequentemente piores que o sucesso.

### 17.2. **Termos Narrativos**

- **Crença Central:** Primeira Reflexão escolhida durante a criação de personagem. Já está "processada" e concede sua Solução imediatamente.
- **Gabinete de Reflexões:** O "cérebro secundário" do personagem onde ideologias, memórias delirantes e filosofias se cristalizam através do processo de internalização.
- **Internalização:** Processo de ocupar um slot vazio com uma ideia descoberta no mundo, passando pelo Problema e recebendo a Solução.
- **Projeção:** Técnica de criação colaborativa onde jogadores inventam detalhes do cenário (NPCs, lugares, objetos) e o Narrador os aceita e complica.
- **Semente:** Origem de uma Reflexão, identificada quando o jogador repete ou defende algo com veemência durante o jogo.
- **Voz:** Cada perícia personificada como uma entidade interna com personalidade própria, interpretada pelo Narrador. Influencia a narrativa independentemente da vontade consciente do personagem.

### 17.3. **Termos de Progressão**

- **Ponto de Atributo:** Recurso para aumentar atributos. Obtido através de eventos narrativos ou gastando 3 Pontos de Perícia acumulados.
- **Ponto de Perícia:** Recurso para aumentar perícias ou comprar slots de Reflexão. Obtido através de XP acumulado (50 XP por ponto).
- **XP (Experiência):** Recurso ganho através de descobertas, sucessos, falhas, progressão narrativa e escolhas ideológicas. Converte-se em Pontos de Perícia.

### 17.4. **Termos de Sobrevivência**

- **Repouso Seguro:** Dormir no mínimo 6 horas fora da rua, em local fechado e razoavelmente seguro. Concede +1 em Moral e Saúde.
- **Dívida Existencial:** Condição imposta quando o personagem gasta além do saldo. Resulta em -1 Vontade mas +2 Retórica contra credores.
- **Subsistência:** Necessidades diárias de moradia (R$ 15), alimentação (R$ 15) e higiene (R$ 5). Ignorar resulta em penalidades progressivas.

### 17.5. **Termos de Jogada**

- **CD (Dificuldade da Provação):** Número alvo que o resultado do teste deve alcançar ou superar para ter sucesso.
- **Initiativa:** Determinação de ordem de ação em conflitos físicos, baseada em Velocidade de Reação.
- **Teste Ativo:** Rolagem de dados feita pelo jogador quando decide usar uma perícia conscientemente.
